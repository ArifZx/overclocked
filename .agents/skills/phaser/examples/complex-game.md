...
export class HUD extends Phaser.Scene {
  ...
  create() {
    ...
    this.healthText = this.add.text(
      UI.PADDING,
      UI.PADDING + UI.LINE_HEIGHT,
      `Health: ${gameState.health}`,
      {
        fontSize: UI.FONT_SIZE,
        color: UI.HEALTH_COLOR,
      },
    );
...
export class GameOver extends Phaser.Scene {
  ...
  create() {
    ...
    this.add
      .text(cx, cy + 20, `Score: ${gameState.score}`, {
        fontSize: UI.FONT_SIZE,
        color: UI.FONT_COLOR,
      })
      .setOrigin(0.5);
    ...
    if (gameState.bestScore > 0) {
      this.add
        .text(cx, cy + 60, `Best: ${gameState.bestScore}`, {
          fontSize: UI.FONT_SIZE,
          color: "#ffff00",
        })
        .setOrigin(0.5);
    ...
    this.add
      .text(cx, cy + 110, "Click to restart", {
        fontSize: "18px",
        color: "#aaaaaa",
      })
      .setOrigin(0.5);
